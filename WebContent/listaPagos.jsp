...
<%@ include file="menuEsquerda.jsp"%>  
    ...
    <div class="col-md-9">
        <!-- Página aqui -->	
      <!-- column 2 -->	
      <strong><i class="glyphicon glyphicon-dashboard"></i> Lista de Pedidos para retirada</strong>
		<hr>
			<div class="row">
     			<table class="table">
     				<thead>
     				...
     				<tbody>
     				<c:forEach items="${listaPagos}" var="pedido">
     				<tr>
     					...
     					<td><a class="btn btn-primary btn-xs" href="Controladora?action=editarConserto&id=${pedido.id}">Editar</a>
     						<a class="btn btn-success btn-xs" href="Controladora?action=finalizar&id=${pedido.id}" onClick="confirm('Deseja realizar essa ação?')">Finalizado</a>
     					</td>
     				</tr>
     				</tbody>
     				</c:forEach>
